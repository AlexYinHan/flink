...
**Note**: "Compatible" here refers specifically to compatibility of the internal data format used in savepoints. It does not cover compatibility of SQL operators or other Upper-level changes.
